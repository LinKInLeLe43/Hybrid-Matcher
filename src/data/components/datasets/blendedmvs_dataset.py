...
class BlendedMVSDataset(data.Dataset):
    def __init__(
        self,
        npz_path: str,
        data_root: str,
    ...
    def __getitem__(self, idx: int) -> Dict[str, Any]:
        ...
        image_path0 = join(self.data_root, '{}_{}.png'.format(scene_id, image_name0))
        image_path1 = join(self.data_root, '{}_{}.png'.format(scene_id, image_name1))
