...
def compute_error(
    ...
    epipolar_errors_per_batch = _compute_epipolar_errors(
        result["coarse_cls_indices"][0], result["points0"], result["points1"],
    ...
    if advanced:
        ...
        (error["end_point_errors_per_batch"],
         ...
         error["inlier_coarse_3x3_precisions"]
            ...
            result["coarse_cls_indices"][0], result["points0"],
            result["points1"], batch["depth0"], batch["depth1"], batch["K0"],
            batch["K1"], batch["T0_to_1"], coarse_scale, scale1, coarse_w1,
            result["coarse_cls_indices"][2], inliers_per_batch,
