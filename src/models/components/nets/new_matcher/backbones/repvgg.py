...
def create_RepVGG_A1(deploy=False, use_checkpoint=False):
    return RepVGG(num_blocks=[2, 4, 14], num_classes=1000,
                  width_multiplier=[1, 1, 1], override_groups_map=None, deploy=deploy, use_checkpoint=use_checkpoint)

def create_RepVGG_A2(deploy=False, use_checkpoint=False):
    return RepVGG(num_blocks=[2, 4, 14], num_classes=1000,
                  width_multiplier=[1.5, 1.5, 1.5], override_groups_map=None, deploy=deploy, use_checkpoint=use_checkpoint)
