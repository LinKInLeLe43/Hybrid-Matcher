...
class HybridMatcherNet(nn.Module):
    ...
    def forward(
        ...
        if batch["image0"].shape == batch["image1"].shape:
            ...
            coarse_features = self.local_coc(coarse_features, mask=mask)
            ...
            coarse_feature0 = self.local_coc(coarse_feature0, mask=mask0)
            ...
            coarse_feature1 = self.local_coc(coarse_feature1, mask=mask1)
        ...
        coarse_feature0, coarse_feature1, flow0, flow1 = self.coarse_module(
            coarse_feature0, coarse_feature1, size0, size1, pos0=pos_feature0,
            pos1=pos_feature1, mask0=mask0, mask1=mask1)
