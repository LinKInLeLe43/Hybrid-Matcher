...
class FinePreprocess(nn.Module):
    ...
    def _crop_fine_only(
        ...
        fine_feature1 = _crop_windows(fine_feature1, w + 2 * e + 2 * w, s, p + e + w)
    ...
    def _fuse_coarse_after_crop_fine(
        ...
        if e == 0:
            ...
            coarse_feature1 = coarse_feature1.expand(-1, (w + 2 * e + 2 * w) ** 2, -1)
    ...
    def forward(
        ...
        if m == 0:
            ...
            fine_feature1 = torch.empty((0, (w + 2 * e + 2 * w) ** 2, c), device=device)
            return fine_feature0, fine_feature1
